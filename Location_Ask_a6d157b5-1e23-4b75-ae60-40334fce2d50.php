...
<body>
	<form name="form1" method="post" enctype="multipart/form-data"
		...
		<center>
			...
			<p>
				Patient ID : <select name="upatientid_fake" size="1">
					<option selected value="0">請選擇</option>
					<option value="b1dc2c14-b474-4406-9942-efda363c9593">Tzu-Yu Kuo</option>
					<option value="b1dc2c14-b474-4406-9942-efda363c9593">Ching-Wei Chen</option>
					<option value="b1dc2c14-b474-4406-9942-efda363c9593">Cheng-Wei
						Hsiao</option>
					<option value="b1dc2c14-b474-4406-9942-efda363c9593">Kuang-Jer Tam</option>
					<option value="b1dc2c14-b474-4406-9942-efda363c9593">Chun-Chieh
						Chan</option>
				</select> Minute
			</p>
